...
<c:if test="${session_theme eq null}">
	<c:set var="session_theme"
		value="${pageContext.request.contextPath}/resources/css/mine/common_theme_one.css"
		scope="session" />
</c:if>
...
<!-- Jaskirat common CSS -->
<link id="pagestyle"
	href="<c:url value="/resources/css/mine/common.css" />"
	rel="stylesheet">


<!-- Jaskirat lightbox CSS -->
<link id="pagestyle"
	href="<c:out value="${sessionScope.session_theme}" />" rel="stylesheet">
	...
	<div id="wrapper">
		...
		<div class="modal fade" id="loginModal" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="square" style="background: #AEF2D4"
						id="<c:url value="/resources/css/mine/common_theme_one.css"/>"
						onclick="set_theme(this.id)"></div>

					<div class="square" style="background: #CCFECD"
						id="<c:url value="/resources/css/mine/common_theme_two.css"/>"
						onclick="set_theme(this.id)"></div>
					<div class="square" style="background: #C6FFFF"
						id="<c:url value="/resources/css/mine/common_theme_three.css"/>"
						onclick="set_theme(this.id)"></div>

					<!-- 2nd row verticaly centered images in square columns -->

					<div class="square" style="background: #FFCECD"
						id="<c:url value="/resources/css/mine/common_theme_four.css"/>"
						onclick="set_theme(this.id)"></div>
					<div class="square" style="background: #FFCEFF"
						id="<c:url value="/resources/css/mine/common_theme_five.css"/>"
						onclick="set_theme(this.id)"></div>
					<div class="square" style="background: #FFFCCC"
						id="<c:url value="/resources/css/mine/common_theme_six.css"/>"
						onclick="set_theme(this.id)"></div>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation"
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" style="color: #3981C7;" href="index.html">
					Repair and Maintenance Module </a>
			</div>
			<!-- /.navbar-header -->
